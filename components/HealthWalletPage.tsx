...
const I18N: Record<string, Record<string, string>> = {
  ...
  es: {
    back: "Volver", title: "Cartera de Salud", medications: "Medicamentos", insurance: "Seguro",
    allergies: "Alergias", diagnoses: "Diagnósticos", doctors: "Doctores", pharmacies: "Farmacia",
    emergency: "Contactos de Emergencia", vaccinations: "Vacunas", surgeries: "Cirugías",
    add: "Agregar", save: "Guardar", cancel: "Cancelar", delete: "Eliminar", edit: "Editar",
    name: "Nombre", phone: "Teléfono", address: "Dirección", notes: "Notas",
    noData: "No hay registros aún", loading: "Cargando...",
    medName: "Medicamento", dosage: "Dosis", frequency: "Frecuencia", purpose: "Propósito",
    prescriber: "Médico", pharmacy: "Farmacia", active: "Activo",
    carrier: "Aseguradora", planName: "Plan", memberId: "ID de Miembro", groupNum: "Grupo #",
    policyHolder: "Titular", effectiveDate: "Fecha Efectiva", expiryDate: "Fecha de Vencimiento",
    allergen: "Alérgeno", type: "Tipo", reaction: "Reacción", severity: "Gravedad",
    diagnosis: "Diagnóstico", icdCode: "Código ICD", specialty: "Especialidad", clinic: "Clínica",
    isPcp: "Médico Primario", relationship: "Relación", vaccineName: "Vacuna", dateGiven: "Fecha",
    procedure: "Procedimiento", datePerformed: "Fecha", surgeon: "Cirujano", hospital: "Hospital",
  },
  zh: {
    back: "返回", title: "健康手册", medications: "用药", insurance: "保险",
    allergies: "过敏", diagnoses: "诊断", doctors: "医生", pharmacies: "药房",
    emergency: "紧急联系人", vaccinations: "疫苗接种", surgeries: "手术记录",
    add: "添加", save: "保存", cancel: "取消", delete: "删除", edit: "编辑",
    name: "姓名", phone: "电话", address: "地址", notes: "备注",
    noData: "暂无记录", loading: "加载中...",
    medName: "药名", dosage: "剂量", frequency: "频率", purpose: "用途",
    prescriber: "处方医生", pharmacy: "药房", active: "使用中",
    carrier: "保险公司", planName: "计划", memberId: "会员号", groupNum: "组号",
    policyHolder: "投保人", effectiveDate: "生效日期", expiryDate: "到期日期",
    allergen: "过敏原", type: "类型", reaction: "反应", severity: "严重程度",
    diagnosis: "诊断", icdCode: "ICD代码", specialty: "专科", clinic: "诊所",
    isPcp: "家庭医生", relationship: "关系", vaccineName: "疫苗", dateGiven: "日期",
    procedure: "手术", datePerformed: "日期", surgeon: "外科医生", hospital: "医院",
  },
  vi: {
    back: "Quay lại", title: "Sổ Sức Khỏe", medications: "Thuốc", insurance: "Bảo hiểm",
    allergies: "Dị ứng", diagnoses: "Chẩn đoán", doctors: "Bác sĩ", pharmacies: "Nhà thuốc",
    emergency: "Liên hệ khẩn cấp", vaccinations: "Tiêm chủng", surgeries: "Phẫu thuật",
    add: "Thêm", save: "Lưu", cancel: "Hủy", delete: "Xóa", edit: "Sửa",
    name: "Tên", phone: "Điện thoại", address: "Địa chỉ", notes: "Ghi chú",
    noData: "Chưa có dữ liệu", loading: "Đang tải...",
    medName: "Tên thuốc", dosage: "Liều lượng", frequency: "Tần suất", purpose: "Mục đích",
    prescriber: "Bác sĩ kê đơn", pharmacy: "Nhà thuốc", active: "Đang dùng",
    carrier: "Công ty BH", planName: "Gói", memberId: "Mã thành viên", groupNum: "Số nhóm",
    policyHolder: "Chủ hợp đồng", effectiveDate: "Ngày hiệu lực", expiryDate: "Ngày hết hạn",
    allergen: "Chất gây dị ứng", type: "Loại", reaction: "Phản ứng", severity: "Mức độ",
    diagnosis: "Chẩn đoán", icdCode: "Mã ICD", specialty: "Chuyên khoa", clinic: "Phòng khám",
    isPcp: "BS gia đình", relationship: "Quan hệ", vaccineName: "Vắc-xin", dateGiven: "Ngày",
    procedure: "Thủ thuật", datePerformed: "Ngày", surgeon: "Bác sĩ PT", hospital: "Bệnh viện",
  },
  ja: {
    back: "戻る", title: "健康手帳", medications: "お薬", insurance: "保険証",
    allergies: "アレルギー", diagnoses: "診断", doctors: "医師", pharmacies: "薬局",
    emergency: "緊急連絡先", vaccinations: "予防接種", surgeries: "手術歴",
    add: "追加", save: "保存", cancel: "キャンセル", delete: "削除", edit: "編集",
    name: "名前", phone: "電話番号", address: "住所", notes: "メモ",
    noData: "まだ登録がありません", loading: "読み込み中...",
    medName: "薬名", dosage: "用量", frequency: "服用頻度", purpose: "目的",
    prescriber: "処方医", pharmacy: "薬局", active: "服用中",
    carrier: "保険会社", planName: "プラン", memberId: "会員番号", groupNum: "グループ番号",
    policyHolder: "契約者", effectiveDate: "有効開始日", expiryDate: "有効期限",
    allergen: "原因物質", type: "種類", reaction: "反応", severity: "重症度",
    diagnosis: "診断名", icdCode: "ICDコード", specialty: "専門", clinic: "クリニック",
    isPcp: "かかりつけ医", relationship: "続柄", vaccineName: "ワクチン", dateGiven: "接種日",
    procedure: "手術名", datePerformed: "手術日", surgeon: "執刀医", hospital: "病院",
  },
};
