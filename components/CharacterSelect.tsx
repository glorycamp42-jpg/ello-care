...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    // ElevenLabs premade "Matilda" — warm, mature female; multilingual v2 handles Korean.
    // Distinct from the granddaughter voice so the two personas don't sound identical.
